...
| Plugin migrations | **0001–0005 applied**, incl. 0003 (mastery), 0004 (difficulty_band) and 0005 (mastery source), against the live DB with real data. Confirmed with `showmigrations`: all five show `[X]` | `tools/ops/migrate.sh` |
